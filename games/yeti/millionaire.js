...
function initGame() {
    ...
    if(flag==0) {
        ...
        for(var i=flag; i<5; i++) {
            if(i==flag)
                quesbank.push(Question.getBySubCat(5, question.category));
            else
                quesbank.unshift(Question.getByWeightExSubcat(5,question.category));
        }
    }
}
...
function playGame() {
    ...
    for(var i=0;i<question.options.length;i++){
        if(question.options[i].correct=="true"){
            //correct_option=question.options[i];
            correct_option=i;
        }
    }
            ...
            if (data.correct == "true") {
                ...
                setTimeout(function() {
                    ...
                    if (gameOn)
                        ...
                        endGame("I am very pleased.You did not make the wrong choice even though you needed my help. I am happy to direct now. Go forward!", question);
...
function endGame(message, question) {
    ...
    //" direct now. Go forward!") {
        if (message == "I am very pleased.You did not make the wrong choice even though you needed my help. I am happy to direct now. Go forward!" ){
            //" direct now. Go forward!") {
