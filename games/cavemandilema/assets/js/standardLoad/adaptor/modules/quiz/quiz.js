...
function loadQuestionBank() {
    for (var i in questionbank.questions) {
        ...
        new Question(q._id, q.name, q.image, q.weight, options, q.help, q.slide, q.subslide, q.answered);
    }
    return true;
}
...
var Question = Fiber.extend(function () {
    return {
        init: function (_id, name, image, weight, options, help, slide, subslide, answered) {
			this._id = _id;
            this.name = name;
            this.image = image;
