...
function initBackpack() {
    ...
    $(".back-pack-icon").unbind('click').on('click', function() {
        ...
        $('#back_pack_table').css('height','auto');
        ...
        $('.mid-slide .mid-slide-div').fadeIn();
...
function bindZoneSections(direction) {
    ...
    $('.video-zone').unbind('click').on('click',function (){
        ...
        $('#video_table').html('');
        $('#video_table').append('<div class="close-btn video-close"><img src="img/close_grey.png" id="close_btn" class="slide_btn" width="60%" ></div>' +
        '<video id="player1" src="'+videos[id].file+'" width=100% height=100%></video>')
    }); 
